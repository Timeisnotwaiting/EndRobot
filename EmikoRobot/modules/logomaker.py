...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        async for i in ubot2.iter_messages(
            "@keshav_alpha", filter=InputMessagesFilterPhotos
        ):
            pics.append(i)
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [Killua](https://t.me/killua_group_bot)",
...
async def logo_(event):
    ...
    if event.reply_to_msg_id:
        ...
        pics = []
        async for i in ubot2.iter_messages(
            "@alpha_zoldyck", filter=InputMessagesFilterPhotos
        ):
            pics.append(i)
        id_ = random.choice(pics)
        bg_ = await id_.download_media()
    ...
    if not bg_:
        pics = []
        async for i in ubot2.iter_messages(
            "@alphazoldyck", filter=InputMessagesFilterPhotos
        ):
            pics.append(i)
        id_ = random.choice(pics)
        bg_ = await id_.download_media()
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        pics = []
        async for i in ubot2.iter_messages(
            "@Timeisnotwaiting", filter=InputMessagesFilterPhotos
        ):
            pics.append(i)
        id_ = random.choice(pics)
        bg_ = await id_.download_media()
