...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/killua_group_bot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[killua Robot ❤️](https://t.me/THE_END_NETWORK):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Asynchorous)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
